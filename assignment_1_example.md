...
## Student Information
* **Name:** [Josephine de Boer]
* **Student ID:** [15502422]
* **TA Name:** [Jan Hutter]
* **GitHub Repository:** [https://github.com/fiendeboer/mlops.git](https://github.com/fiendeboer/mlops.git)
...
1. **Connection Details:**
   - **Command:** `[ssh scur2272@snellius.surf.nl]`
   - **Login Node:** int4
   - **Screenshot:** ![Screenshot 1](screenshot1.png)
...
3. **Smooth Connection (If applicable):**
   - **SSH Client:** [OpenSSH 8.7p1]
   - **Prior Experience:** [During Information Visualization last year we had to do something similar to this, but this is my only prior experience with SSH.]
   - **Preemptive Steps:** [I followed the steps provided by the GitHub Docs: 
